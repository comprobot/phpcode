    ...
    <div class="page-wrapper bg-gra-03 p-t-45 p-b-50">
        <div class="wrapper wrapper--w790">
           ...
           <div class="content">
			...
			<div class="form-row">
			     <div class="name">歡迎, <strong><?php echo $_SESSION['username']; ?></strong></div>
 			</div>			
			
			<div id="tab_list" class="ah-tab-wrapper">
                <div class="ah-tab">
                    <a class="ah-tab-item" data-ah-tab-active="true" href="">上載宣傳片</a>
                    <a class="ah-tab-item" href="">檢視用戶數據 </a>
                    <a class="ah-tab-item" href="">購買宣傳套餐</a> 
	                <a class="ah-tab-item" href="">付款歷史</a> 
					<a class="ah-tab-item" href="">顧客兌換商品 </a> 
				    <a class="ah-tab-item" href="">增加顧客兌換商品</a> 
			...
			<div class="form-row">
			     <div class="row row-space"><strong>上載宣傳片</strong>(只支援 mp4, mov 及 avi 影片)</div>				 
 			</div>			
			<div class="form-row">
			<?php 
			...
			?>
				...
				<div class="row row-space"><strong>你的影片已被批准及上架</strong></div>				 
			...
			?>
				...
				<div class="row row-space"><strong>你的影片不被批准 </strong></div>				 
			...
			?>
				...
				<div class="row row-space"><strong>你的影片審核中</strong></div>				 
			...
			<button class="btn btn--radius-2 btn--red" name="upload_video" id="upload_video" type="submit">上載影片</button>
...
<!--<iframe src="paypal.html?username=<?php echo $_SESSION['username']; ?>" width="100%" height="600" frameborder="0" scrolling="yes"></iframe>
			...
			<?php while ($row = mysqli_fetch_array($results)) { ?>
				<tr>
					...
					<td><?php echo $row['tm']; ?></td>											
					<td>
						<a href="aserver.php?item_id=<?php echo $row['item_id']; ?>&delete_item=delete_item&adminuser=<?php echo $_SESSION['username']?>" class="edit_btn" >刪除</a>
					</td>					
			</tr>
		 ...
		 <!--<div id="tab_list_content" class="ah-tab-content-wrapper">	-->
			...
			<?php include('errors.php'); ?>
			<div class="form-row">
			     <div class="row row-space"><strong>上戴兌換貨品 </strong></div>				 
 			</div>			
			<div >
			<div class="form-row">			
			  <div class="row row-space">                  
			...
			<div class="form-row">
              <div class="row row-space"><strong>貨品名稱:</strong> </div>
                <div class="value">
			...
			<div class="form-row">
              <div class="row row-space"><strong>貨品數目:</strong> </div>
                <div class="value">
			...
			<div class="form-row">
              <div class="row row-space"><strong>貨品描述:</strong> </div>
                <div class="value">
                  <div class="input-group">
			...
			<div class="form-row">
              <div class="row row-space"><strong>貨品兌換分數:</strong> </div>
                <div class="value">
                  <div class="input-group">
			...
			<button class="btn btn--radius-2 btn--red" name="upload_item" id="upload_item" type="submit">上載貨品</button>
			...
			<div class="form-row">
				<div class="name"> <a href="adv_user_home.php?logout='1'" style="color: red;">登出</a></div>
			</div>			
