        ...
        <div class="wrapper wrapper--w790">
           ...
           <div class="content">
			...
			?>
				...
				<div class="row row-space"><strong>Your video is Pending </strong></div>				 
...
<!--<iframe src="paypal.html?username=<?php echo $_SESSION['username']; ?>" width="100%" height="600" frameborder="0" scrolling="yes"></iframe>
			...
			<?php while ($row = mysqli_fetch_array($results)) { ?>
				<tr>
					...
					<td><?php echo $row['tm']; ?></td>											
					<td>
						<a href="aserver.php?item_id=<?php echo $row['item_id']; ?>&delete_item=delete_item&adminuser=<?php echo $_SESSION['username']?>" class="edit_btn" >DELETE</a>
					</td>					
			</tr>
