	...
	$("#signupForm").validate({
	       rules: {				
			...
			messages: {
				...
				store_address: "Please enter your store address",
				target_user: "Please enter your targert user",				
        ...
        <div class="wrapper wrapper--w790">
            <div class="card card-5">
                <div class="card-heading">
                    <h2 class="title">Store User Registration Form</h2>
                </div>
                <div class="card-body">
                    <form method="POST" action="#" id="signupForm" name="signupForm">
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="store_name" name="store_name" id='store_name' value="<?php echo $store_name; ?>" > <label for="store_name" class="error"></label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="name">Store Address</div>
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="store_address" name="store_address" id='store_address' value="<?php echo $store_address; ?>" > <label for="store_address" class="error"></label>
                                </div>
                            </div>
                        </div>

                        <div class="form-row">
                            <div class="name">Target User</div>
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="target_user" name="target_user" id='target_user' value="<?php echo $target_user; ?>" > <label for="target_user" class="error"></label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
							...
							<button class="btn btn--radius-2 btn--red" name="register_store" id="register_store" >Register</button>
                        </div>
                    </form>
                </div>
            </div>
